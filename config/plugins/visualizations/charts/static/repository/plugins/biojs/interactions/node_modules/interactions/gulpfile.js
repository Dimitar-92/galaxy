 ...
 * https://github.com/4ndr01d3/biojs-vis-interactions-d3
 *
...
var buildDir = "build";
var outputFile = "biojsvisinteractionsd3";
...
gulp.task('build-browser-min',['init'], function() {
  var b = browserify({hasExports: true, standalone: "biojs-vis-interactions-d3"});
  exposeBundles(b);
  return b.bundle()
